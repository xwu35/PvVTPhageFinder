...
@click.command(
    ...
    help='Usage:\n python PvVTPhageFinder --reads_dir <reads directory> --sample_info <sample information table> --output_dir <output directory> '
    '--reference_genome <reference genome sequences>'
)
@click.option(
    '--reads_dir',
    required=True,
...
@click.option(
    '--output_dir',
    default="PvVTPhageFinder_OUTPUT",
...
def run_pvvtphagefinder(reads_dir, sample_info, output_dir, reference_genome, 
          nonprophage_identity, mapper, assembler, 
          step, dryrun, conda_envs, profile):
          ...
          if not dryrun:
            ...
            with open(logfile, "w") as log:
                log.write("================PvVTPhageFinder run log==============\n")
